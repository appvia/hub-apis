...
func schema_pkg_apis_clusters_v1_ClusterCredential(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterCredential is the Schema for the roles API",
				Type:        []string{"object"},
...
func schema_pkg_apis_clusters_v1_ClusterCredentialSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterCredentialSpec defines the desired state of ClusterCredential",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"caCertificate": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_clusters_v1_ClusterCredentialStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterCredentialStatus defines the observed state of ClusterCredential",
				Type:        []string{"object"},
			},
		},
	}
