...
func schema_pkg_apis_config_v1_ClassInstance(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClassInstance is the Schema for the classinstances API",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_config_v1_ClassInstanceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClassInstanceSpec defines the desired state of ClassInstance",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"classRef": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"classRef", "configurationRef"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_config_v1_ClassInstanceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClassInstanceStatus defines the observed state of ClassInstance",
				Type:        []string{"object"},
			},
		},
	}
