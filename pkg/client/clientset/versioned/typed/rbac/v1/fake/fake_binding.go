...
func (c *FakeBindings) Get(name string, options v1.GetOptions) (result *rbacv1.Binding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(bindingsResource, name), &rbacv1.Binding{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeBindings) List(opts v1.ListOptions) (result *rbacv1.BindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(bindingsResource, bindingsKind, opts), &rbacv1.BindingList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeBindings) Create(binding *rbacv1.Binding) (result *rbacv1.Binding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(bindingsResource, binding), &rbacv1.Binding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Binding), err
...
func (c *FakeBindings) Update(binding *rbacv1.Binding) (result *rbacv1.Binding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(bindingsResource, binding), &rbacv1.Binding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Binding), err
...
func (c *FakeBindings) UpdateStatus(binding *rbacv1.Binding) (*rbacv1.Binding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(bindingsResource, "status", binding), &rbacv1.Binding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Binding), err
...
func (c *FakeBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(bindingsResource, name), &rbacv1.Binding{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(bindingsResource, listOptions)
...
func (c *FakeBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *rbacv1.Binding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(bindingsResource, name, pt, data, subresources...), &rbacv1.Binding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Binding), err
