...
import (
	v1 "github.com/appvia/hub-apis/pkg/client/clientset/versioned/typed/config/v1"
...
func (c *FakeConfigV1) Classes(namespace string) v1.ClassInterface {
	return &FakeClasses{c, namespace}
}
