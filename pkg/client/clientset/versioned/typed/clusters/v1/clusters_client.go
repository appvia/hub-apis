...
func NewForConfig(c *rest.Config) (*ClustersV1Client, error) {
	config := *c
	...
	return &ClustersV1Client{client}, nil
}

// NewForConfigOrDie creates a new ClustersV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ClustersV1Client {
...
// New creates a new ClustersV1Client for the given RESTClient.
func New(c rest.Interface) *ClustersV1Client {
	return &ClustersV1Client{c}
}
...
func (c *ClustersV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
