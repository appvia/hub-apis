	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OrgV1().Workspaces(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OrgV1().Workspaces(namespace).Watch(options)
			},
		},
		&orgv1.Workspace{},
		resyncPeriod,
...
func (f *workspaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&orgv1.Workspace{}, f.defaultInformer)
}
