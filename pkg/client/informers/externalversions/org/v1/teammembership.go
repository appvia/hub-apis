...
// TeamMembershipInformer provides access to a shared informer and lister for
// TeamMemberships.
type TeamMembershipInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1.TeamMembershipLister
}
...
func (f *teamMembershipInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&orgv1.TeamMembership{}, f.defaultInformer)
}

func (f *teamMembershipInformer) Lister() v1.TeamMembershipLister {
	return v1.NewTeamMembershipLister(f.Informer().GetIndexer())
}
