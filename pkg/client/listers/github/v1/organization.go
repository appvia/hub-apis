...
// List lists all Organizations in the indexer for a given namespace.
func (s organizationNamespaceLister) List(selector labels.Selector) (ret []*v1.Organization, err error) {
...
// Get retrieves the Organization from the indexer for a given namespace and name.
func (s organizationNamespaceLister) Get(name string) (*v1.Organization, error) {
